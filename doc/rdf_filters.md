...
[https://rdflib.readthedocs.io/en/latest/apidocs/rdflib.query/`rdflib.query.Result`).](https://rdflib.readthedocs.io/en/latest/apidocs/rdflib.query/`rdflib.query.Result`).) In the
...
See [https://rdflib.readthedocs.io/en/latest/apidocs/rdflib.query/`rdflib.query.Result`.](https://rdflib.readthedocs.io/en/latest/apidocs/rdflib.query/`rdflib.query.Result`.)
